...
```{r Bed capacity per county, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.align="center", fig.width=10, fig.height=7, fig.cap="Figure 1: Bar Chart showing Bed Capacity per Kenyan Counties"}
...
datatable(HF_LevelTypes, rownames = TRUE, options = list(pageLength = 5, scrollX=T),
          class = 'display',
          caption = htmltools::tags$caption(
            style = 'caption-side: bottom; text-align: center;',
            'Table 2: ', htmltools::em('Frequency Table showing relationship Facility Types and levels')
            )
          )
